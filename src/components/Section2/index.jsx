...
const Section2 = () => {
  return (
    <div className="section-2">
      ...
      <p className="text-description">
        <ScrollAnimation animateIn="animate__fadeInRightBig">
          Ông Nguyễn Hiền - dân cư thuộc khu ĐTM An Vân Dương, phường Xuân Phú,
          TP. Huế - nói: “Sang năm, chú trả lại đất cho Nhà nước rồi. Nghe đâu
          có dự án xây chung cư cao cấp. Chỗ ni mà xây xong thì mùa mưa lụt,
          nước ứ trong xóm, chẳng biết thoát ra cửa nào”.
        </ScrollAnimation>
      </p>
      <p className="text-description" style={{ fontWeight: "bold" }}>
        <ScrollAnimation animateIn="animate__fadeInRightBig">
          Chỗ ni mà xây xong thì mùa mưa lụt, nước ứ trong xóm, chẳng biết thoát
          ra cửa nào
        </ScrollAnimation>
      </p>
      ...
      >
        <ScrollAnimation animateIn="animate__bounceInRight">
          Khu đô thị The Manor Crown được ví như một "Paris thu nhỏ" giữa lòng
          Cố Đô, tuy nhiên hiện xung quanh khu đô thị này nước lũ vẫn còn ngập
          úng với độ sâu khoảng 25cm.
        </ScrollAnimation>
      </p>
